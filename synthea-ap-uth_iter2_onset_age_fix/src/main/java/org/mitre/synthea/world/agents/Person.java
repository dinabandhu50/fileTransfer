...
public class Person implements Serializable, QuadTreeData {
  ...
  //Changes for Smoke fix
  public static final String SMOKER_HISTORY = "smoker_history";
  public static final String ALCOHOLIC_HISTORY = "alcoholic_history";
  public static final String ALCOHOLIC_FLAG = "alcoholic_flag";
