...
public final class CardiovascularDiseaseModule extends Module {
  ...
  static {
    ...
    LOOKUP = new HashMap<>();
    // conditions
    LOOKUP.put("stroke", new Code("ICD-10", "I63.9", "Stroke"));
    LOOKUP.put("natural_causes",
        new Code("ICD-10", "R99", "Natural death with unknown cause"));
    LOOKUP.put("coronary_heart_disease",
        new Code("ICD-10", "I25.10", "Coronary Heart Disease"));
    LOOKUP.put("myocardial_infarction", new Code("ICD-10", "I21.9", "Myocardial Infarction"));
    LOOKUP.put("cardiac_arrest", new Code("ICD-10", "I46.9", "Cardiac Arrest"));
    LOOKUP.put("atrial_fibrillation", new Code("ICD-10", "I48.91", "Atrial Fibrillation"));
    LOOKUP.put("cardiovascular_disease",
        new Code("ICD-10", "R94.30", "Disorder of cardiovascular system"));
    LOOKUP.put("history_of_myocardial_infarction",
        new Code("ICD-10", "I25.10", "History of myocardial infarction (situation)"));
    LOOKUP.put("history_of_cardiac_arrest",
        new Code("ICD-10", "Z86.74", "History of cardiac arrest (situation)"));
    ...
    // medications
    LOOKUP.put("clopidogrel", new Code("NDC", "00093731405", "Clopidogrel 75 MG Oral Tablet"));
    LOOKUP.put("simvastatin", new Code("NDC", "00006074054", "Simvastatin 20 MG Oral Tablet"));
    LOOKUP.put("amlodipine", new Code("NDC", "00054010122", "Amlodipine 5 MG Oral Tablet"));
    LOOKUP.put("nitroglycerin",
        new Code("NDC", "21695076849", "Nitroglycerin 0.4 MG/ACTUAT Mucosal Spray"));
    LOOKUP.put("atorvastatin", new Code("NDC", "00071015892", "Atorvastatin 80 MG Oral Tablet"));
    LOOKUP.put("captopril", new Code("NDC", "00003045250", "Captopril 25 MG Oral Tablet"));
    LOOKUP.put("warfarin", new Code("NDC", "00056017275", "Warfarin Sodium 5 MG Oral Tablet"));
    LOOKUP.put("verapamil", new Code("NDC", "00014177131", "Verapamil Hydrochloride 40 MG"));
    LOOKUP.put("digoxin", new Code("NDC", "00081024272", "Digoxin 0.125 MG Oral Tablet"));
    LOOKUP.put("epinephrine",
        new Code("NDC", "00026998406", "1 ML Epinephrine 1 MG/ML Injection"));
    LOOKUP.put("amiodarone",
        new Code("NDC", "00548338000", "3 ML Amiodarone hydrocholoride 50 MG/ML Prefilled Syringe"));
    LOOKUP.put("atropine",
        new Code("NDC", "00223720601", "Atropine Sulfate 1 MG/ML Injectable Solution"));
    LOOKUP.put("alteplase", new Code("NDC", "50242008527", "Alteplase 100 MG Injection"));
